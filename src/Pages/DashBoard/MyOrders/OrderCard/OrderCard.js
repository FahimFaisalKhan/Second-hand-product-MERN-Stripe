...
const OrderCard = ({ order }) => {
  ...
  return (
    <div className="bg-success w-128 rounded shadow-md flex lg:flex-row card text-grey-darkest border-2 border-info min-h-[30rem]">
      ...
      <div className="flex flex-col justify-center w-full">
        ...
        <Link to={`/dashboard/payment/${productId}`}>
          <button className="bg-gray-400 p-3 flex items-center w-10/12 text-warning hover:text-base-100 rounded-r-lg font-medium justify-between transition hover:bg-warning cursor-pointer">
            Pay
